  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 pt-28 md:pt-36 mb-10">
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[10px] tracking-[0.18em] uppercase font-light text-warm-gray">
          <Link to="/" className="hover:text-pistachio transition-colors">Home</Link>
          <span aria-hidden="true">/</span>
          <Link to="/loja" className="hover:text-pistachio transition-colors">Loja</Link>
          <span aria-hidden="true">/</span>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 pb-20 grid md:grid-cols-2 gap-12 md:gap-20">
        ...
        >
          ...
          {/* Corner marks */}
          <div className="absolute top-4 left-4 w-5 h-5 border-t border-l border-pistachio/20" aria-hidden="true" />
          <div className="absolute top-4 right-4 w-5 h-5 border-t border-r border-pistachio/20" aria-hidden="true" />
          <div className="absolute bottom-4 left-4 w-5 h-5 border-b border-l border-pistachio/20" aria-hidden="true" />
          <div className="absolute bottom-4 right-4 w-5 h-5 border-b border-r border-pistachio/20" aria-hidden="true" />
        </motion.div>
        ...
        >
          <p className="text-[9px] tracking-[0.32em] uppercase text-warm-gray mb-4 font-light">
            {product.category}
            {product.weight && <span className="ml-2 text-warm-gray-light">· {product.weight}</span>}
          </p>
          ...
          <div className="mt-8 pt-7 border-t border-cream-deep grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label}>
                ...
                <p className="text-xs font-light text-charcoal">{item.detail}</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <section className="border-t border-cream-deep">
          <div className="max-w-7xl mx-auto px-5 md:px-10 py-16 md:py-20">
            <div className="flex items-center gap-4 mb-12">
              <div className="h-px w-8 bg-pistachio-border" aria-hidden="true" />
